    ...
    assetKeys.forEach(key => {
      ...
      img.onload = () => {
        ...
        const skipFeather =
          ...
          /skylineFar|streetrow|Far_Bg|hangar_bg|airborne_aces_map|medal_badge|parallax_mountains|mountains_cutout|airfield_strip|landing_field|wind_flag_left|finish_flag|wind_sock|training_airship|ruff_|blue_crystal_|cloud_soft_/.test(key);
        if (skipFeather) {
          images[key] = img;
          settle();
        } else {
